...
namespace Growth.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public IActionResult Authenticate([FromBody]UsersResource userResource)
        {
        ...
        [AllowAnonymous]
        [HttpPost("register")]
        public IActionResult Register([FromBody]UsersResource userResource)
        {
            // map dto to entity
        ...
        public IActionResult GetAll()
        {
            ...
            var userDtos = _mapper.Map<IList<UsersResource>>(users);
            return Ok(userDtos);
        }
        ...
        public IActionResult GetById(int id)
        {
            ...
            var userDto = _mapper.Map<UsersResource>(user);
            return Ok(userDto);
        }

        [HttpPut("{id}")]
        public IActionResult Update(int id, [FromBody]UsersResource userResource)
        {
